...
const Particles = () => {
  ...
  /* Track mouse hover state & global pointer */
  ...
  useFrame((state) => {
    ...
    if (hovering.current) {
      ...
      targetX =
        (baseX + jitterX * jitterRadius * DEFAULTS.cursor.strength) *
        followStrength;
      targetY =
        (baseY + jitterY * jitterRadius * DEFAULTS.cursor.strength) *
        followStrength;
    }
